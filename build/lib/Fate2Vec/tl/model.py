...
class Fate2Vec:
    ...
    def __tokenize(self,mt_filtered, multilineage_clones, tokenize_method='spearman', cor_thr=0.2):
    ...
    def __calculate_diversity_metrics(self,row):
    ...
    def embed(self,tokenize_method='spearman',
        ...
        adata.obs['clone_size'] = mt_filtered.sum(axis=1)
